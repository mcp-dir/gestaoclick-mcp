...
GestãoClick segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **GestãoClick** | BR | ERP / business management platform API (data provider) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [gestaoclick@mcp.ai](mailto:gestaoclick@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
